...
%TRLC_CONVERTER% --source=..\..\trlc\swe-test --include=..\..\trlc\model --include=..\..\trlc\swe-req --exclude=..\..\trlc\swe-req --translation=converter\translation.json --verbose --out=%OUTPUT_DIR% --project=%CONVERTER% %OUT_FORMAT%
